    ...
    return (
        <div className="container pt-5 pb-5 ">
            <div className="row">
                ...
                <div className="col-5 text-start" style={{ display: "flex", fontSize: "1.1rem", flexDirection: "column", gap: "0.8rem" }}>
                    ...
                    </p><p> Over 1.6+ crore clients place billions of orders every year through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.
                    </p></div>
                 <div className="col-5 text-start" style={{ display: "flex", fontSize: "1.1rem", flexDirection: "column", gap: "0.8rem" }}>
                    <p>
